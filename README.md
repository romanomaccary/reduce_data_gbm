...
- Obtain the temporal evolution of the peak rates, waiting times, FWHMs, and peak energy, as done in [Maccary et al. 2026](https://fermi.gsfc.nasa.gov/ssc/data/analysis/gbm/gbm_data_tools/gdt-docs/);
